...
import graph.*;
import list.*; // REMOVE REMOVE REMOVE REMOVE JUST FOR TESTING PURPOSES
...
public class WUGTest {
  ...
  private static int edgeTest(Object[] vertArray) {
    ...
    System.out.println("Removing vertex 3.");
   // System.out.println("vertex 3 has " + ((DListNode)(g.vertices.find(vertArray[3]).value())).adjList().length());
    System.out.println("vertex 3 degree is " + g.degree(vertArray[3]));
  //  System.out.println("vertex 3 adjList " + ((DListNode)(g.vertices.find(vertArray[3]).value())).adjList().toString());
    g.removeVertex(vertArray[3]);
    System.out.println("vertex 3 degree is " + g.degree(vertArray[3]));
   // System.out.println("vertex 3 adjList " + ((DListNode)(g.Vertices.find(vertArray[3]).value())).adjList().toString());
    result = g.vertexCount();
   ...
   // System.out.println("1,1 is edge?" + " " + g.isEdge(vertArray[1], vertArray[1]));
